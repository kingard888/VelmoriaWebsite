...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07111f] px-5 py-10 text-white">
      ...
      <div className="pointer-events-none absolute -right-40 bottom-0 h-[500px] w-[500px] rounded-full bg-blue-500/10 blur-[120px]" />
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-7 shadow-2xl backdrop-blur-xl sm:p-9">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-white/40">
              Masuk kembali ke akun adventurer-mu.
            </p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-cyan-300 py-3.5 text-sm font-semibold text-[#07111f] transition hover:bg-cyan-200"
            >
              Masuk
            </button>
          </form>
